...
public class LessonBuilderAccessService {
	...
	public static final String useCSPDefault = "sandbox allow-forms allow-scripts allow-top-navigation allow-popups allow-pointer-lock";
					...
					try {
						...
						else
						{
							...
							if (inline && dangerous && useCsp) {
							    ...
							    res.addHeader("X-Content-Security-Policy", useCSPHeaders);
							}
