		...
		<div class="sakai-table-toolBar">
			...
			<h:panelGroup layout="block" styleClass="sakai-table-buttonContainer threadOptions" rendered="#{!ForumTool.threadMoved}">
				<div id="messNavHolder">
					<h:outputLink styleClass="button jumpToNew" value="#messageNewnewMess0" rendered="#{!ForumTool.selectedTopic.topic.autoMarkThreadsRead && (!ForumTool.selectedThreadHead.read || ForumTool.selectedThreadHead.childUnread > 0)}">
						<h:outputText value="#{msgs.cdfm_gotofirstnewtitle}" />
					</h:outputLink>
				</div>
