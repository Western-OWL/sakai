...
export class SakaiRubricCriterionEdit extends RubricsElement {
  ...
  render() {
    ...
    return html`
      <a tabindex="0" role="button" class="linkStyle edit fa fa-fw fa-edit" @focus="${this.onFocus}" @keyup="${this.openEditWithKeyboard}" @click="${this.editCriterion}" title="${tr("edit_criterion")} ${this.criterion.title}" href="#"></a>
