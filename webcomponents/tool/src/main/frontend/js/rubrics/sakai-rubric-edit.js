...
export class SakaiRubricEdit extends RubricsElement {
  ...
  render() {
    ...
    return html`
      <a class="linkStyle edit fa fa-fw fa-edit" role="button" aria-haspopup="true" aria-expanded="${this.popoverOpen}" aria-controls="edit_rubric_${this.rubric.id}" tabindex="0" @keyup="${this.openEditWithKeyboard}" @click="${this.editRubric}" title="${tr("edit_rubric")} ${this.rubric.title}" href="#"></a>
