...
<h:outputLink title="#{questionPoolMessages.t_toggletree}" id="parenttogglelink"  onclick="toggleRows(this);return false;" value="#" styleClass="treefolder" rendered="#{questionpool.tree.hasChildList}" >
