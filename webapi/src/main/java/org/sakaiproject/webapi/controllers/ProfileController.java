...
public class ProfileController extends AbstractSakaiApiController {
    ...
    private static final String SAK_PROP_WEBAPI_PROFILE_ENABLED = "webapi.profile.enabled";
    private static final boolean SAK_PROP_WEBAPI_PROFILE_ENABLED_DEFAULT = true;
    ...
    public ResponseEntity<ProfileRestBean> getUserProfile(@PathVariable String userId) throws UserNotDefinedException {
        ...
        if (!serverConfigurationService.getBoolean(SAK_PROP_WEBAPI_PROFILE_ENABLED, SAK_PROP_WEBAPI_PROFILE_ENABLED_DEFAULT)) {
            throw new EndpointDisabledException("Profile is disabled");
        }
